...
vec3 CalcDirectionalLight(vec3 normal, vec3 view_dir) {
    ...
    vec3 light_dir = normalize(-light.direction);  // Directional light direction is opposite to light rays
    ...
    // No attenuation for directional lights (they're infinitely far away)
